...
\ell(b_x)\leq\alpha\]
      ...
      \item Seja \(\alpha < h(T)\) e assuma que existem \(x,y\in T_\alpha\)
          ...
          \(x<y\). 
          Neste caso, temos que $\{\zeta \in T \text{ : } \zeta < x\} \subsetneq \{\zeta \in T \text{ : } \zeta < y\}$. 
          Mas \(h(x)=h(y)\), absurdo, pois $h(x)$ deveria ser menor que $h(y)$.\qedhere
...
\begin{exercicio}\label{3.3}
  ...
  \emph{Dica do livro: Seja \(U_\alpha=\{x\in T_\alpha\,\colon\card{\succc{x}}=\kappa\}\). Prove que
...
\end{exercicio}
\begin{proof}[Solução]
    Observemos que a dica do livro não vale em geral: considere a árvore
