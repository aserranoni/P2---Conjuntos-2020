...
\ell(b_x)\leq\alpha\]
 ...
 \end{equation*}é uma representação de
  ...
  \end{teo}
\begin{proof}
  Em primeiro lugar, observamos que\footnote{Este fato é verdade pois se $\alpha < \omega$, $\alpha$ é um ordinal sucessor, e portanto o fato segue sem dificuldades do item (iv) do Exercício \ref{3.1}} se  \(T\) é uma árvore de altura \(\omega\), então cada nó de \(T\) possui
